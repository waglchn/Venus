	...
	namespace core
	{
		...
		public:
				...
				const vector3d<T>& lineVect, vector3d<T>& outIntersection) const
			{
				...
				core::triangle3d<venus::f64> trianglef64(vector3d<f64>((f64)pointA.X, (f64)pointA.Y, (f64)pointA.Z)
					, vector3d<f64>((f64)pointB.X, (f64)pointB.Y, (f64)pointB.Z)
					, vector3d<f64>((f64)pointC.X, (f64)pointC.Y, (f64)pointC.Z));
				const vector3d<venus::f64> normalf64 = trianglef64.getNormal().normalize();
				f64 t2;
