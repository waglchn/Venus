...
namespace venus
{
	...
	//! Base class of most objects of the Venus Engine.
	/** This class provides reference counting through the methods grab() and drop().
	It also is able to store a debug string for every instance of an object.
	Most objects of the Venus
	Engine are derived from IReferenceCounted, and so they are reference counted.

	When you create an object in the Venus engine, calling a method
	...
	*/
	...
	public:
		...
		the Venus Engine are derived from IReferenceCounted, and so
		they are reference counted.

		When you create an object in the Venus engine, calling a
		...
		objects of the Venus Engine are derived from
		...
		bool drop() const
		{
			...
			DEBUG_BREAK_IF(ReferenceCounter <= 0)
