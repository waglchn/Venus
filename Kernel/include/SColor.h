...
namespace venus
{
	namespace video
	{
		//! An enum for the color format of textures used by the Venus Engine.
		/** A color format specifies how color information is stored. */
		enum ECOLOR_FORMAT
		{
			//! 16 bit color format used by the software driver.
			/** It is thus preferred by all other Venus engine video drivers.
		...
		/** In Venus, alpha refers to opacity.
		...
		Alpha in Venus is opacity, so 0 is fully transparent, 255 is fully opaque (solid).
		This class is used by most parts of the Venus Engine
