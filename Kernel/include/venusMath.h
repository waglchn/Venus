...
#if defined(_SOLARIS_PLATFORM_) || defined(__BORLANDC__) || defined (__BCPLUSPLUS__) || defined (_WIN32_WCE)
#define sqrtf(X) (venus::f32)sqrt((venus::f64)(X))
#define sinf(X) (venus::f32)sin((venus::f64)(X))
#define cosf(X) (venus::f32)cos((venus::f64)(X))
#define asinf(X) (venus::f32)asin((venus::f64)(X))
#define acosf(X) (venus::f32)acos((venus::f64)(X))
#define atan2f(X,Y) (venus::f32)atan2((venus::f64)(X),(venus::f64)(Y))
#define ceilf(X) (venus::f32)ceil((venus::f64)(X))
#define floorf(X) (venus::f32)floor((venus::f64)(X))
#define powf(X,Y) (venus::f32)pow((venus::f64)(X),(venus::f64)(Y))
#define fmodf(X,Y) (venus::f32)fmod((venus::f64)(X),(venus::f64)(Y))
#define fabsf(X) (venus::f32)fabs((venus::f64)(X))
#define logf(X) (venus::f32)log((venus::f64)(X))
#endif
...
#undef PI64
		...
		*/
		...
		// avoid ambiguity when swapping objects of an Venus type that has not
